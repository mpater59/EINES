...
def runNetwork():
    ...
    net.addLink(h2, s1)
    net.addLink(h3, s1)
    TCLink(s1, s2, bw=1, delay='200ms', loss=0, max_queue_size=1000, use_htb=True)
    net.addLink(s1, s2)
    TCLink(s1, s3, bw=1, delay='200ms', loss=0, max_queue_size=1000, use_htb=True)
    net.addLink(s1, s3)
    TCLink(s1, s4, bw=1, delay='200ms', loss=0, max_queue_size=1000, use_htb=True)
    net.addLink(s1, s4)
    net.addLink(s2, s5)
    net.addLink(s3, s5)
    net.addLink(s4, s5)
